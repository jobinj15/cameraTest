  ...
  getDialogContent() {
    return (
      <View
        ...
        <Text style={[styles.stripLabel, {flex: undefined, marginBottom: 20}]}>
          {constants.TXT_SELECT_THEME}
        </Text>
  ...
  render() {
    return (
      <View
        style={[
          styles.styleFull,
          {backgroundColor: colors.WHITE, paddingHorizontal: 5},
        ]}>
        <FlatList
  ...
  getHeader() {
    return (
      <View
        ...
        <View
          style={global.getCircleViewStyle(90, {
        ...
        <View style={{flex: 1, marginLeft: 15}}>
          ...
          <Text
            style={[
              styles.labelSmall,
              {color: colors.DISCOUNT, alignSelf: 'stretch'},
            ]}
            numberOfLines={1}>
    ...
    return (
      <TouchableWithoutFeedback
        ...
        <View
          ...
          <View style={{flex: 1, marginLeft: 15}}>
            <Text style={[styles.productKey]}>{item.text}</Text>

            {item.desc ? (
              <Text style={[styles.labelSmall, {color: colors.DISCOUNT}]}>
                {item.desc}
              </Text>
            ) : (
              <View />
